Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "bin/piston", "config/hoe.rb", "config/requirements.rb", "History.txt", "lib/piston/cli.rb", "lib/piston/commands/base.rb", "lib/piston/commands/convert.rb", "lib/piston/commands/import.rb", "lib/piston/commands/info.rb", "lib/piston/commands/lock_unlock.rb", "lib/piston/commands/status.rb", "lib/piston/commands/update.rb", "lib/piston/commands/upgrade.rb", "lib/piston/commands.rb", "lib/piston/git/client.rb", "lib/piston/git/commit.rb", "lib/piston/git/repository.rb", "lib/piston/git/working_copy.rb", "lib/piston/git.rb", "lib/piston/repository.rb", "lib/piston/revision.rb", "lib/piston/svn/client.rb", "lib/piston/svn/repository.rb", "lib/piston/svn/revision.rb", "lib/piston/svn/working_copy.rb", "lib/piston/svn.rb", "lib/piston/version.rb", "lib/piston/working_copy.rb", "lib/piston.rb", "lib/subclass_responsibility_error.rb", "License.txt", "log/.gitignore", "Manifest.txt", "piston.gemspec", "Rakefile", "README.txt", "samples/common.rb", "samples/import_git_git.rb", "samples/import_git_svn.rb", "samples/import_svn_git.rb", "samples/import_svn_svn.rb", "script/destroy", "script/generate", "script/txt2html", "setup.rb", "tasks/deployment.rake", "tasks/environment.rake", "tasks/manifest.rake", "tasks/samples.rake", "tasks/test.rake", "tasks/website.rake", "test/integration/test_git_git.rb", "test/integration/test_git_svn.rb", "test/integration/test_import_svn_git.rb", "test/integration/test_svn_svn.rb", "test/integration_helpers.rb", "test/spec_suite.rb", "test/test_helper.rb", "test/unit/git/commit/test_checkout.rb", "test/unit/git/commit/test_each.rb", "test/unit/git/commit/test_rememberance.rb", "test/unit/git/commit/test_validation.rb", "test/unit/git/repository/test_at.rb", "test/unit/git/repository/test_basename.rb", "test/unit/git/repository/test_branchanme.rb", "test/unit/git/repository/test_guessing.rb", "test/unit/git/working_copy/test_copying.rb", "test/unit/git/working_copy/test_creation.rb", "test/unit/git/working_copy/test_existence.rb", "test/unit/git/working_copy/test_finalization.rb", "test/unit/git/working_copy/test_guessing.rb", "test/unit/git/working_copy/test_rememberance.rb", "test/unit/svn/repository/test_at.rb", "test/unit/svn/repository/test_basename.rb", "test/unit/svn/repository/test_guessing.rb", "test/unit/svn/revision/test_checkout.rb", "test/unit/svn/revision/test_each.rb", "test/unit/svn/revision/test_rememberance.rb", "test/unit/svn/revision/test_validation.rb", "test/unit/svn/working_copy/test_copying.rb", "test/unit/svn/working_copy/test_creation.rb", "test/unit/svn/working_copy/test_existence.rb", "test/unit/svn/working_copy/test_externals.rb", "test/unit/svn/working_copy/test_finalization.rb", "test/unit/svn/working_copy/test_guessing.rb", "test/unit/svn/working_copy/test_rememberance.rb", "test/unit/test_info.rb", "test/unit/test_lock_unlock.rb", "test/unit/test_repository.rb", "test/unit/test_revision.rb", "test/unit/working_copy/test_guessing.rb", "test/unit/working_copy/test_info.rb", "test/unit/working_copy/test_rememberance.rb", "test/unit/working_copy/test_validate.rb", "tmp/.gitignore", "TODO", "website/index.html", "website/index.txt", "website/javascripts/rounded_corners_lite.inc.js", "website/stylesheets/screen.css", "website/template.rhtml"]
  s.has_rdoc = true
